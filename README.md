...
```
go get github.com/ttsubo2000/contrail-go-api
```

The types package is generated using the command:
```
tools/generateds/generateDS.py -f -o $GOPATH/src/github.com/ttsubo2000/contrail-go-api/types -g golang-api controller/src/schema/vnc_cfg.xsd
```
...
Pre-generated tar files with the generated types are also available as part of each release. The golang types corresponding to the schema defined by OpenContrail R2.20 are available at:
 - https://github.com/ttsubo2000/contrail-go-api/releases/download/1.0.0/contrail-go-api-generated-types-r2.20.tar.gz

To build the CLI command:
```
go install github.com/ttsubo2000/contrail-go-api/cli
```
