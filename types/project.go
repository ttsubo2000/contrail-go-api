...
const (
	...
	project_grpc_profiles
	project_snmp_profiles
	project_netconf_profiles
...
type Project struct {
	...
	grpc_profiles contrail.ReferenceList
	snmp_profiles contrail.ReferenceList
	netconf_profiles contrail.ReferenceList
...
func (obj *Project) readGrpcProfiles() error {
        if !obj.IsTransient() &&
                !obj.valid[project_grpc_profiles] {
                err := obj.GetField(obj, "grpc_profiles")
                if err != nil {
                        return err
                }
        }
...
func (obj *Project) GetGrpcProfiles() (
        contrail.ReferenceList, error) {
        err := obj.readGrpcProfiles()
        if err != nil {
                return nil, err
        }
        return obj.grpc_profiles, nil
}

func (obj *Project) readSnmpProfiles() error {
        if !obj.IsTransient() &&
                !obj.valid[project_snmp_profiles] {
                err := obj.GetField(obj, "snmp_profiles")
                if err != nil {
                        return err
                }
        }
...
func (obj *Project) GetSnmpProfiles() (
        contrail.ReferenceList, error) {
        err := obj.readSnmpProfiles()
        if err != nil {
                return nil, err
        }
        return obj.snmp_profiles, nil
}

func (obj *Project) readNetconfProfiles() error {
        if !obj.IsTransient() &&
                !obj.valid[project_netconf_profiles] {
                err := obj.GetField(obj, "netconf_profiles")
                if err != nil {
                        return err
                }
        }
...
func (obj *Project) GetNetconfProfiles() (
        contrail.ReferenceList, error) {
        err := obj.readNetconfProfiles()
        if err != nil {
                return nil, err
        }
        return obj.netconf_profiles, nil
}
...
func (obj *Project) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "sflow_profiles":
                        ...
                        break
                case "grpc_profiles":
                        err = json.Unmarshal(value, &obj.grpc_profiles)
                        if err == nil {
                                obj.valid[project_grpc_profiles] = true
                        }
                        break
                case "snmp_profiles":
                        err = json.Unmarshal(value, &obj.snmp_profiles)
                        if err == nil {
                                obj.valid[project_snmp_profiles] = true
                        }
                        break
                case "netconf_profiles":
                        err = json.Unmarshal(value, &obj.netconf_profiles)
                        if err == nil {
                                obj.valid[project_netconf_profiles] = true
                        }
                        break
