...
const (
	...
	routing_policy_interface_route_table_refs
...
func (obj *RoutingPolicy) readInterfaceRouteTableRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[routing_policy_interface_route_table_refs] {
...
func (obj *RoutingPolicy) GetInterfaceRouteTableRefs() (
...
func (obj *RoutingPolicy) AddInterfaceRouteTable(
        ...
        if !obj.modified[routing_policy_interface_route_table_refs] {
        ...
        obj.modified[routing_policy_interface_route_table_refs] = true
        return nil
}

func (obj *RoutingPolicy) DeleteInterfaceRouteTable(uuid string) error {
        err := obj.readInterfaceRouteTableRefs()
        if err != nil {
                return err
        }
...
func (obj *RoutingPolicy) ClearInterfaceRouteTable() {
        if obj.valid[routing_policy_interface_route_table_refs] &&
           !obj.modified[routing_policy_interface_route_table_refs] {
                obj.storeReferenceBase("interface-route-table", obj.interface_route_table_refs)
        }
        obj.interface_route_table_refs = make([]contrail.Reference, 0)
        obj.valid[routing_policy_interface_route_table_refs] = true
        obj.modified[routing_policy_interface_route_table_refs] = true
}

func (obj *RoutingPolicy) SetInterfaceRouteTableList(
