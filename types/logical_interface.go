...
const (
	...
	logical_interface_logical_interface_port_params
...
func (obj *LogicalInterface) GetLogicalInterfacePortParams() PortParameters {
        return obj.logical_interface_port_params
}

func (obj *LogicalInterface) SetLogicalInterfacePortParams(value *PortParameters) {
        obj.logical_interface_port_params = *value
        obj.modified[logical_interface_logical_interface_port_params] = true
}
...
func (obj *LogicalInterface) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[logical_interface_logical_interface_port_params] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.logical_interface_port_params)
                if err != nil {
                        return nil, err
                }
                msg["logical_interface_port_params"] = &value
        }
...
func (obj *LogicalInterface) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "logical_interface_vlan_tag":
                        ...
                        break
                case "logical_interface_port_params":
                        err = json.Unmarshal(value, &obj.logical_interface_port_params)
                        if err == nil {
                                obj.valid[logical_interface_logical_interface_port_params] = true
                        }
                        break
