...
const (
	...
	service_health_check_virtual_network_back_refs
...
func (obj *ServiceHealthCheck) readVirtualNetworkBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[service_health_check_virtual_network_back_refs] {
...
func (obj *ServiceHealthCheck) GetVirtualNetworkBackRefs() (
        contrail.ReferenceList, error) {
...
func (obj *ServiceHealthCheck) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "virtual_network_back_refs":
                        ...
                        if err == nil {
                                obj.valid[service_health_check_virtual_network_back_refs] = true
                        }
                        break
