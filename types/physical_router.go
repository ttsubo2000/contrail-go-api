...
const (
	...
	physical_router_physical_router_onboarding_state
...
type PhysicalRouter struct {
	...
	physical_router_onboarding_state string
...
func (obj *PhysicalRouter) GetPhysicalRouterOnboardingState() string {
        return obj.physical_router_onboarding_state
}

func (obj *PhysicalRouter) SetPhysicalRouterOnboardingState(value string) {
        obj.physical_router_onboarding_state = value
        obj.modified[physical_router_physical_router_onboarding_state] = true
}
...
func (obj *PhysicalRouter) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[physical_router_physical_router_onboarding_state] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.physical_router_onboarding_state)
                if err != nil {
                        return nil, err
                }
                msg["physical_router_onboarding_state"] = &value
        }
...
func (obj *PhysicalRouter) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "physical_router_managed_state":
                        ...
                        break
                case "physical_router_onboarding_state":
                        err = json.Unmarshal(value, &obj.physical_router_onboarding_state)
                        if err == nil {
                                obj.valid[physical_router_physical_router_onboarding_state] = true
                        }
                        break
