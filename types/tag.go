...
const (
	...
	tag_config_properties_back_refs
	...
	tag_snmp_profile_back_refs
	tag_node_back_refs
	tag_grpc_profile_back_refs
...
type Tag struct {
	...
	netconf_profile_back_refs contrail.ReferenceList
	...
	config_properties_back_refs contrail.ReferenceList
	...
	snmp_profile_back_refs contrail.ReferenceList
	node_back_refs contrail.ReferenceList
	grpc_profile_back_refs contrail.ReferenceList
...
func (obj *Tag) readNetconfProfileBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[tag_netconf_profile_back_refs] {
                err := obj.GetField(obj, "netconf_profile_back_refs")
                if err != nil {
                        return err
                }
        }
...
func (obj *Tag) GetNetconfProfileBackRefs() (
        contrail.ReferenceList, error) {
        err := obj.readNetconfProfileBackRefs()
        if err != nil {
                return nil, err
        }
        return obj.netconf_profile_back_refs, nil
}
...
func (obj *Tag) readConfigPropertiesBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[tag_config_properties_back_refs] {
                err := obj.GetField(obj, "config_properties_back_refs")
                if err != nil {
                        return err
                }
        }
...
func (obj *Tag) GetConfigPropertiesBackRefs() (
        contrail.ReferenceList, error) {
        err := obj.readConfigPropertiesBackRefs()
        if err != nil {
                return nil, err
        }
        return obj.config_properties_back_refs, nil
}
...
func (obj *Tag) readSnmpProfileBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[tag_snmp_profile_back_refs] {
                err := obj.GetField(obj, "snmp_profile_back_refs")
                if err != nil {
                        return err
                }
        }
...
func (obj *Tag) GetSnmpProfileBackRefs() (
        contrail.ReferenceList, error) {
        err := obj.readSnmpProfileBackRefs()
        if err != nil {
                return nil, err
        }
        return obj.snmp_profile_back_refs, nil
}
...
func (obj *Tag) readGrpcProfileBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[tag_grpc_profile_back_refs] {
                err := obj.GetField(obj, "grpc_profile_back_refs")
                if err != nil {
                        return err
                }
        }
...
func (obj *Tag) GetGrpcProfileBackRefs() (
        contrail.ReferenceList, error) {
        err := obj.readGrpcProfileBackRefs()
        if err != nil {
                return nil, err
        }
        return obj.grpc_profile_back_refs, nil
}
...
func (obj *Tag) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "analytics_alarm_node_back_refs":
                        ...
                        break
                case "netconf_profile_back_refs":
                        err = json.Unmarshal(value, &obj.netconf_profile_back_refs)
                        if err == nil {
                                obj.valid[tag_netconf_profile_back_refs] = true
                        }
                        break
                ...
                case "network_ipam_back_refs":
                        ...
                        break
                case "config_properties_back_refs":
                        err = json.Unmarshal(value, &obj.config_properties_back_refs)
                        if err == nil {
                                obj.valid[tag_config_properties_back_refs] = true
                        }
                        break
                ...
                case "access_control_list_back_refs":
                        ...
                        break
                case "snmp_profile_back_refs":
                        err = json.Unmarshal(value, &obj.snmp_profile_back_refs)
                        if err == nil {
                                obj.valid[tag_snmp_profile_back_refs] = true
                        }
                        break
                case "node_back_refs":
                        ...
                        break
                case "grpc_profile_back_refs":
                        err = json.Unmarshal(value, &obj.grpc_profile_back_refs)
                        if err == nil {
                                obj.valid[tag_grpc_profile_back_refs] = true
                        }
                        break
