...
const (
	...
	virtual_router_virtual_router_sriov_physical_networks
...
func (obj *VirtualRouter) GetVirtualRouterSriovPhysicalNetworks() KeyValuePairs {
        return obj.virtual_router_sriov_physical_networks
}

func (obj *VirtualRouter) SetVirtualRouterSriovPhysicalNetworks(value *KeyValuePairs) {
        obj.virtual_router_sriov_physical_networks = *value
        obj.modified[virtual_router_virtual_router_sriov_physical_networks] = true
}
...
func (obj *VirtualRouter) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[virtual_router_virtual_router_sriov_physical_networks] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.virtual_router_sriov_physical_networks)
                if err != nil {
                        return nil, err
                }
                msg["virtual_router_sriov_physical_networks"] = &value
        }
...
func (obj *VirtualRouter) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "virtual_router_dpdk_enabled":
                        ...
                        break
                case "virtual_router_sriov_physical_networks":
                        err = json.Unmarshal(value, &obj.virtual_router_sriov_physical_networks)
                        if err == nil {
                                obj.valid[virtual_router_virtual_router_sriov_physical_networks] = true
                        }
                        break
