...
const (
	...
	interface_route_table_routing_policy_back_refs
...
func (obj *InterfaceRouteTable) readRoutingPolicyBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[interface_route_table_routing_policy_back_refs] {
...
func (obj *InterfaceRouteTable) GetRoutingPolicyBackRefs() (
        contrail.ReferenceList, error) {
...
func (obj *InterfaceRouteTable) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "routing_policy_back_refs":
                        ...
                        if err == nil {
                                obj.valid[interface_route_table_routing_policy_back_refs] = true
                        }
                        break
