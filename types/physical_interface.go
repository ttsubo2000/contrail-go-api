...
const (
	...
	physical_interface_physical_interface_flow_control
	physical_interface_physical_interface_lacp_force_up
	physical_interface_physical_interface_port_params
...
type PhysicalInterface struct {
	...
	physical_interface_flow_control bool
	physical_interface_lacp_force_up bool
...
func (obj *PhysicalInterface) GetPhysicalInterfaceFlowControl() bool {
        return obj.physical_interface_flow_control
}

func (obj *PhysicalInterface) SetPhysicalInterfaceFlowControl(value bool) {
        obj.physical_interface_flow_control = value
        obj.modified[physical_interface_physical_interface_flow_control] = true
}

func (obj *PhysicalInterface) GetPhysicalInterfaceLacpForceUp() bool {
        return obj.physical_interface_lacp_force_up
}

func (obj *PhysicalInterface) SetPhysicalInterfaceLacpForceUp(value bool) {
        obj.physical_interface_lacp_force_up = value
        obj.modified[physical_interface_physical_interface_lacp_force_up] = true
}

func (obj *PhysicalInterface) GetPhysicalInterfacePortParams() PortParameters {
        return obj.physical_interface_port_params
}

func (obj *PhysicalInterface) SetPhysicalInterfacePortParams(value *PortParameters) {
        obj.physical_interface_port_params = *value
        obj.modified[physical_interface_physical_interface_port_params] = true
}
...
func (obj *PhysicalInterface) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[physical_interface_physical_interface_flow_control] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.physical_interface_flow_control)
                if err != nil {
                        return nil, err
                }
                msg["physical_interface_flow_control"] = &value
        }

        if obj.modified[physical_interface_physical_interface_lacp_force_up] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.physical_interface_lacp_force_up)
                if err != nil {
                        return nil, err
                }
                msg["physical_interface_lacp_force_up"] = &value
        }

        if obj.modified[physical_interface_physical_interface_port_params] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.physical_interface_port_params)
                if err != nil {
                        return nil, err
                }
                msg["physical_interface_port_params"] = &value
        }
...
func (obj *PhysicalInterface) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "physical_interface_port_id":
                        ...
                        break
                case "physical_interface_flow_control":
                        err = json.Unmarshal(value, &obj.physical_interface_flow_control)
                        if err == nil {
                                obj.valid[physical_interface_physical_interface_flow_control] = true
                        }
                        break
                case "physical_interface_lacp_force_up":
                        err = json.Unmarshal(value, &obj.physical_interface_lacp_force_up)
                        if err == nil {
                                obj.valid[physical_interface_physical_interface_lacp_force_up] = true
                        }
                        break
                case "physical_interface_port_params":
                        err = json.Unmarshal(value, &obj.physical_interface_port_params)
                        if err == nil {
                                obj.valid[physical_interface_physical_interface_port_params] = true
                        }
                        break
                case "id_perms":
