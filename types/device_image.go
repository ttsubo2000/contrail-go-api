...
const (
	device_image_device_image_file_name = iota
	device_image_device_image_vendor_name
...
func (obj *DeviceImage) GetDeviceImageFileName() string {
        return obj.device_image_file_name
}

func (obj *DeviceImage) SetDeviceImageFileName(value string) {
        obj.device_image_file_name = value
        obj.modified[device_image_device_image_file_name] = true
}
...
func (obj *DeviceImage) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[device_image_device_image_file_name] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.device_image_file_name)
                if err != nil {
                        return nil, err
                }
                msg["device_image_file_name"] = &value
        }
...
func (obj *DeviceImage) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                switch key {
                case "device_image_file_name":
                        err = json.Unmarshal(value, &obj.device_image_file_name)
                        if err == nil {
                                obj.valid[device_image_device_image_file_name] = true
                        }
                        break
