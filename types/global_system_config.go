...
const (
	...
	global_system_config_fast_convergence_parameters
	...
	global_system_config_route_replication_threshold
	...
	global_system_config_config_propertiess
...
type GlobalSystemConfig struct {
	...
	fast_convergence_parameters FastConvergenceParametersType
	...
	rd_cluster_seed int
	route_replication_threshold int
	...
	config_propertiess contrail.ReferenceList
...
func (obj *GlobalSystemConfig) GetFastConvergenceParameters() FastConvergenceParametersType {
        return obj.fast_convergence_parameters
}

func (obj *GlobalSystemConfig) SetFastConvergenceParameters(value *FastConvergenceParametersType) {
        obj.fast_convergence_parameters = *value
        obj.modified[global_system_config_fast_convergence_parameters] = true
}
...
func (obj *GlobalSystemConfig) GetRouteReplicationThreshold() int {
        return obj.route_replication_threshold
}

func (obj *GlobalSystemConfig) SetRouteReplicationThreshold(value int) {
        obj.route_replication_threshold = value
        obj.modified[global_system_config_route_replication_threshold] = true
}
...
func (obj *GlobalSystemConfig) readConfigPropertiess() error {
        if !obj.IsTransient() &&
                !obj.valid[global_system_config_config_propertiess] {
                err := obj.GetField(obj, "config_propertiess")
                if err != nil {
                        return err
                }
        }
...
func (obj *GlobalSystemConfig) GetConfigPropertiess() (
        contrail.ReferenceList, error) {
        err := obj.readConfigPropertiess()
        if err != nil {
                return nil, err
        }
        return obj.config_propertiess, nil
}
...
func (obj *GlobalSystemConfig) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[global_system_config_fast_convergence_parameters] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.fast_convergence_parameters)
                if err != nil {
                        return nil, err
                }
                msg["fast_convergence_parameters"] = &value
        }
        ...
        if obj.modified[global_system_config_route_replication_threshold] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.route_replication_threshold)
                if err != nil {
                        return nil, err
                }
                msg["route_replication_threshold"] = &value
        }
...
func (obj *GlobalSystemConfig) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "graceful_restart_parameters":
                        ...
                        break
                case "fast_convergence_parameters":
                        err = json.Unmarshal(value, &obj.fast_convergence_parameters)
                        if err == nil {
                                obj.valid[global_system_config_fast_convergence_parameters] = true
                        }
                        break
                case "plugin_tuning":
                ...
                case "rd_cluster_seed":
                        ...
                        break
                case "route_replication_threshold":
                        err = json.Unmarshal(value, &obj.route_replication_threshold)
                        if err == nil {
                                obj.valid[global_system_config_route_replication_threshold] = true
                        }
                        break
                ...
                case "alarms":
                        ...
                        break
                case "config_propertiess":
                        err = json.Unmarshal(value, &obj.config_propertiess)
                        if err == nil {
                                obj.valid[global_system_config_config_propertiess] = true
                        }
                        break
                case "job_templates":
