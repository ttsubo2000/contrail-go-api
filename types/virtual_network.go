...
const (
	...
	virtual_network_mac_ip_learning_enable
	...
	virtual_network_service_health_check_refs
...
func (obj *VirtualNetwork) GetMtu() int {
        return obj.mtu
}

func (obj *VirtualNetwork) SetMtu(value int) {
        obj.mtu = value
        obj.modified[virtual_network_mtu] = true
}
...
func (obj *VirtualNetwork) GetMacIpLearningEnable() bool {
        return obj.mac_ip_learning_enable
}

func (obj *VirtualNetwork) SetMacIpLearningEnable(value bool) {
        obj.mac_ip_learning_enable = value
        obj.modified[virtual_network_mac_ip_learning_enable] = true
}
...
func (obj *VirtualNetwork) readServiceHealthCheckRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[virtual_network_service_health_check_refs] {
...
func (obj *VirtualNetwork) GetServiceHealthCheckRefs() (
        contrail.ReferenceList, error) {
...
func (obj *VirtualNetwork) AddServiceHealthCheck(
        ...
        if !obj.modified[virtual_network_service_health_check_refs] {
        ...
        obj.modified[virtual_network_service_health_check_refs] = true
        return nil
}

func (obj *VirtualNetwork) DeleteServiceHealthCheck(uuid string) error {
        err := obj.readServiceHealthCheckRefs()
        if err != nil {
                return err
        }
...
func (obj *VirtualNetwork) ClearServiceHealthCheck() {
        if obj.valid[virtual_network_service_health_check_refs] &&
           !obj.modified[virtual_network_service_health_check_refs] {
                obj.storeReferenceBase("service-health-check", obj.service_health_check_refs)
        }
        obj.service_health_check_refs = make([]contrail.Reference, 0)
        obj.valid[virtual_network_service_health_check_refs] = true
        obj.modified[virtual_network_service_health_check_refs] = true
}

func (obj *VirtualNetwork) SetServiceHealthCheckList(
        refList []contrail.ReferencePair) {
...
func (obj *VirtualNetwork) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[virtual_network_mtu] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.mtu)
                if err != nil {
                        return nil, err
                }
                msg["mtu"] = &value
        ...
        if obj.modified[virtual_network_mac_ip_learning_enable] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.mac_ip_learning_enable)
                if err != nil {
                        return nil, err
                }
                msg["mac_ip_learning_enable"] = &value
        }
...
func (obj *VirtualNetwork) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "is_shared":
                        ...
                        break
                case "mtu":
                        err = json.Unmarshal(value, &obj.mtu)
                        if err == nil {
                                obj.valid[virtual_network_mtu] = true
                        }
                        break
                case "external_ipam":
                ...
                case "igmp_enable":
                        ...
                        break
                case "mac_ip_learning_enable":
                        err = json.Unmarshal(value, &obj.mac_ip_learning_enable)
                        if err == nil {
                                obj.valid[virtual_network_mac_ip_learning_enable] = true
                        }
                        break
                case "id_perms":
