...
const (
	...
	virtual_port_group_virtual_machine_interface_back_refs
...
func (obj *VirtualPortGroup) readVirtualMachineInterfaceBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[virtual_port_group_virtual_machine_interface_back_refs] {
...
func (obj *VirtualPortGroup) GetVirtualMachineInterfaceBackRefs() (
        contrail.ReferenceList, error) {
...
func (obj *VirtualPortGroup) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "virtual_machine_interface_back_refs": {
                        ...
                        obj.valid[virtual_port_group_virtual_machine_interface_back_refs] = true
