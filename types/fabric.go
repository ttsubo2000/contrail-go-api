...
const (
	...
	fabric_disable_vlan_vn_uniqueness_check
	fabric_id_perms
	fabric_perms2
	fabric_annotations
	fabric_display_name
	...
	fabric_tag_refs
	fabric_logical_router_back_refs
	fabric_data_center_interconnect_back_refs
...
type Fabric struct {
	...
	disable_vlan_vn_uniqueness_check bool
...
func (obj *Fabric) GetDisableVlanVnUniquenessCheck() bool {
        return obj.disable_vlan_vn_uniqueness_check
}

func (obj *Fabric) SetDisableVlanVnUniquenessCheck(value bool) {
        obj.disable_vlan_vn_uniqueness_check = value
        obj.modified[fabric_disable_vlan_vn_uniqueness_check] = true
}
...
func (obj *Fabric) readLogicalRouterBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[fabric_logical_router_back_refs] {
...
func (obj *Fabric) GetLogicalRouterBackRefs() (
        contrail.ReferenceList, error) {
...
func (obj *Fabric) readDataCenterInterconnectBackRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[fabric_data_center_interconnect_back_refs] {
...
func (obj *Fabric) GetDataCenterInterconnectBackRefs() (
        contrail.ReferenceList, error) {
...
func (obj *Fabric) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[fabric_disable_vlan_vn_uniqueness_check] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.disable_vlan_vn_uniqueness_check)
                if err != nil {
                        return nil, err
                }
                msg["disable_vlan_vn_uniqueness_check"] = &value
        }
...
func (obj *Fabric) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "fabric_enterprise_style":
                        ...
                        break
                case "disable_vlan_vn_uniqueness_check":
                        err = json.Unmarshal(value, &obj.disable_vlan_vn_uniqueness_check)
                        if err == nil {
                                obj.valid[fabric_disable_vlan_vn_uniqueness_check] = true
                        }
                        break
                case "id_perms":
                ...
                case "logical_router_back_refs":
                        ...
                        if err == nil {
                                obj.valid[fabric_logical_router_back_refs] = true
                        }
                        break
                case "data_center_interconnect_back_refs":
                        err = json.Unmarshal(value, &obj.data_center_interconnect_back_refs)
                        if err == nil {
                                obj.valid[fabric_data_center_interconnect_back_refs] = true
                        }
                        break
