...
func (obj *LogicalRouter) readFabricRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[logical_router_fabric_refs] {
...
func (obj *LogicalRouter) GetFabricRefs() (
        contrail.ReferenceList, error) {
...
func (obj *LogicalRouter) AddFabric(
        rhs *Fabric) error {
        err := obj.readFabricRefs()
        if err != nil {
                return err
        ...
        if !obj.modified[logical_router_fabric_refs] {
        ...
        obj.modified[logical_router_fabric_refs] = true
        return nil
}

func (obj *LogicalRouter) DeleteFabric(uuid string) error {
        err := obj.readFabricRefs()
        if err != nil {
                return err
        }
...
func (obj *LogicalRouter) ClearFabric() {
        if obj.valid[logical_router_fabric_refs] &&
           !obj.modified[logical_router_fabric_refs] {
                obj.storeReferenceBase("fabric", obj.fabric_refs)
        }
        obj.fabric_refs = make([]contrail.Reference, 0)
        obj.valid[logical_router_fabric_refs] = true
        obj.modified[logical_router_fabric_refs] = true
}

func (obj *LogicalRouter) SetFabricList(
        refList []contrail.ReferencePair) {
        obj.ClearFabric()
