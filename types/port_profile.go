...
const (
	port_profile_port_profile_params = iota
	port_profile_id_perms
	port_profile_perms2
...
func (obj *PortProfile) GetPortProfileParams() PortProfileParameters {
        return obj.port_profile_params
}

func (obj *PortProfile) SetPortProfileParams(value *PortProfileParameters) {
        obj.port_profile_params = *value
        obj.modified[port_profile_port_profile_params] = true
}
...
func (obj *PortProfile) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[port_profile_port_profile_params] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.port_profile_params)
                if err != nil {
                        return nil, err
                }
                msg["port_profile_params"] = &value
        }
...
func (obj *PortProfile) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                switch key {
                case "port_profile_params":
                        err = json.Unmarshal(value, &obj.port_profile_params)
                        if err == nil {
                                obj.valid[port_profile_port_profile_params] = true
                        }
                        break
                case "id_perms":
