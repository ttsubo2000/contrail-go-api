...
const (
	...
	data_center_interconnect_fabric_refs
...
func (obj *DataCenterInterconnect) readFabricRefs() error {
        if !obj.IsTransient() &&
                !obj.valid[data_center_interconnect_fabric_refs] {
...
func (obj *DataCenterInterconnect) GetFabricRefs() (
        contrail.ReferenceList, error) {
...
func (obj *DataCenterInterconnect) AddFabric(
        rhs *Fabric) error {
        err := obj.readFabricRefs()
        if err != nil {
                return err
        ...
        if !obj.modified[data_center_interconnect_fabric_refs] {
        ...
        obj.modified[data_center_interconnect_fabric_refs] = true
        return nil
}

func (obj *DataCenterInterconnect) DeleteFabric(uuid string) error {
        err := obj.readFabricRefs()
        if err != nil {
                return err
        }
...
func (obj *DataCenterInterconnect) ClearFabric() {
        if obj.valid[data_center_interconnect_fabric_refs] &&
           !obj.modified[data_center_interconnect_fabric_refs] {
                obj.storeReferenceBase("fabric", obj.fabric_refs)
        }
        obj.fabric_refs = make([]contrail.Reference, 0)
        obj.valid[data_center_interconnect_fabric_refs] = true
        obj.modified[data_center_interconnect_fabric_refs] = true
}

func (obj *DataCenterInterconnect) SetFabricList(
        refList []contrail.ReferencePair) {
        obj.ClearFabric()
