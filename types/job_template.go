...
const (
	...
	job_template_job_template_recovery_playbooks
...
type JobTemplate struct {
	...
	job_template_recovery_playbooks PlaybookInfoListType
...
func (obj *JobTemplate) GetJobTemplateRecoveryPlaybooks() PlaybookInfoListType {
        return obj.job_template_recovery_playbooks
}

func (obj *JobTemplate) SetJobTemplateRecoveryPlaybooks(value *PlaybookInfoListType) {
        obj.job_template_recovery_playbooks = *value
        obj.modified[job_template_job_template_recovery_playbooks] = true
}
...
func (obj *JobTemplate) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified[job_template_job_template_recovery_playbooks] {
                var value json.RawMessage
                value, err := json.Marshal(&obj.job_template_recovery_playbooks)
                if err != nil {
                        return nil, err
                }
                msg["job_template_recovery_playbooks"] = &value
        }
...
func (obj *JobTemplate) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "job_template_playbooks":
                        ...
                        break
                case "job_template_recovery_playbooks":
                        err = json.Unmarshal(value, &obj.job_template_recovery_playbooks)
                        if err == nil {
                                obj.valid[job_template_job_template_recovery_playbooks] = true
                        }
                        break
